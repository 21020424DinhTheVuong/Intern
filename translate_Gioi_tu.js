...
async function run() {
    const parts = [
        ...
        ///////////////
        { text: "input: {    \"data\": [        {            \"word\": \"cũng vậy/cũng thế\",            \"_word\": \"cung vay/cung the\",            \"description\": \"\",            \"tl\": \"Giới từ\"        },        {            \"word\": \"cùng / với (giới từ)\",            \"_word\": \"cung / voi (gioi tu)\",            \"description\": \"\",            \"tl\": \"Giới từ\"        }    ]}" },
        { text: "output: " },
    ];
